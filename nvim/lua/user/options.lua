local options = {
  ...
  incsearch = true,                        -- highlight all matches while typing
  ignorecase = true,                       -- ignore case in search patterns
  mouse = "i",                             -- allow the mouse to be used in neovim in normal mode
  ...
  guicursor = "i:block",                   -- cursor style in insert mode
  sidescrolloff = 8
}
